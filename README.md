...
メモを作成した場合は、安否状況と共に表示してメモがあることを知らせます。ユーザーである他の家族とメモを共有して普段の生活で互いにタスク管理をするよにして使うことができます。
